...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, line):
        ...
        elif cls_name not in self.avl_cls:
    ...
    def do_show(self, line):
        ...
        if len(args) == 0:
            print("** class name missing **")
        elif args[0] not in self.avl_cls:
            print("** class doesn't exist **")
        elif len(args) < 2:
    ...
    def do_destroy(self, arg):
        ...
        if len(commands) == 0:
            print("** class name missing **")
        elif commands[0] not in self.avl_cls:
            print("** class doesn't exist **")
        elif len(commands) < 2:
            print("** instance id missing **")
        else:
